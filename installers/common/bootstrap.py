...
def ensure_app_installed(py: Path) -> None:
    ...
    _log("Installing Intervallic_Homogeneity and dependencies (first run may take a few minutes) …")
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Intervallic_Homogeneity bootstrap")
