# Interval homogeneity regression fixtures (phase 1)

Controlled symbolic fixtures and qualitative/metamorphic tests for **Interval Homogeneity Analyser** (`iav`). Phase 1 validates **musicological semantics of interval distribution concentration** — not aesthetic judgment, not acoustic consonance, and not perceptual dissonance.
