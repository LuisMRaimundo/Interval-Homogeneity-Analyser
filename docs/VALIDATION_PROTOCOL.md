# Validation protocol — Interval Homogeneity Analyser

## What this tool measures

The Interval Homogeneity Analyser computes **symbolic intervallic homogeneity** on notated pitch aggregates:
